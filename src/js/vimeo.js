...
function vimeoCallback() {
  !(function (e, t) {
    ...
    function h() {
      ...
      if ((f(this, '_id', '_WeakMap_' + v() + '.' + v()), 0 < arguments.length))
    ...
    (o =
      ...
      (o.WeakMap =
        (f(h.prototype, 'delete', function (e) {
          if ((m(this, 'delete'), !p(e))) return !1;
          var t = e[this._id];
    ...
    function _(n, r) {
      ...
      (r = T(r)).event
        ? ('error' === r.event &&
            k(n, r.data.method).forEach(function (e) {
              var t = new Error(r.data.message);
              (t.name = r.data.name), e.reject(t), E(n, r.data.method, e);
            }),
          (o = k(n, 'event:'.concat(r.event))),
          (t = r.data))
        : !r.method ||
          ((e = (function (e, t) {
            var n = k(e, t);
      ...
      Player = (function () {
        function Player(u) {
          ...
          if (
            ...
            'IFRAME' === u.nodeName && !c(u.getAttribute('src') || ''))
          )
            ...
            o = new g(function (i, a) {
              ...
              (l._onMessage = function (e) {
                if (c(e.origin) && l.element.contentWindow === e.source) {
                  ...
                  if (r || o)
                    return (
                      l.element.setAttribute('data-ready', 'true'), void i()
                    );
                  _(l, t);
                }
              }),
          ...
          return (
            ...
            V.isEnabled &&
              ...
              (this.fullscreenchangeHandler = function () {
                (V.isFullscreen ? b : E)(l, 'event:exitFullscreen', r),
                  l.ready().then(function () {
                    P(l, 'fullscreenchange', V.isFullscreen);
                  });
              }),
          ...
          (t = [
              ...
              value: function (n, e) {
                ...
                return new g(function (e, t) {
                  return r
                    .ready()
                    .then(function () {
                      b(r, n, { resolve: e, reject: t }), P(r, n, o);
                    })
                    .catch(t);
                });
              },
                ...
                return new g(function (e, t) {
                  return (
                    ...
                    r
                      .ready()
                      .then(function () {
                        b(r, n, { resolve: e, reject: t }), P(r, n);
                      })
                      .catch(t)
                  );
                });
              ...
              value: function (n, r) {
                ...
                return new g(function (e, t) {
                  ...
                  return o
                    .ready()
                    .then(function () {
                      b(o, n, { resolve: e, reject: t }), P(o, n, r);
                    })
                    .catch(t);
                });
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                0 === k(this, 'event:'.concat(e)).length &&
              ...
              value: function () {
                ...
                return new g(function (e) {
                  ...
                  q.delete(n),
                    ...
                    V.isEnabled &&
                      V.off('fullscreenchange', n.fullscreenchangeHandler),
                    e();
                });
              },
            },
    ...
    return (
      e ||
        ...
        (function (e) {
          var a,
            u = 0 < arguments.length && void 0 !== e ? e : document;
          window.VimeoCheckedUrlTimeParam ||
            ...
            window.addEventListener('message', function (e) {
              if (c(e.origin)) {
                ...
                if (t && 'ready' === t.event)
                  for (
                    var n = u.querySelectorAll('iframe'), r = 0;
                    r < n.length;
                    r++
                  ) {
                    var o = n[r],
